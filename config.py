...
class Config(object):
    ...
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "d58f4ba778637c1a6e14b954774bd564")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "5610457536")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://ownerisghost:ROLT60eXwPKmRsCC@urluploader.1ykdmny.mongodb.net/?retryWrites=true&w=majority&appName=UrlUploader")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002004419972")) # your log channel id and make bot admin in log channel with full right 
